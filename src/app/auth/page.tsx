...
function AuthFormContent() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      const msg = err instanceof Error ? err.message : 'Failed to initiate Google authentication. Please check provider configuration.';
      setError(msg);
    }
  };
